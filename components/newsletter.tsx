...
export default function NewsLetter() {
  function handleSubmit() {
    window.open("https://buttondown.email/rarewolf626", "popupwindow");
  }
      ...
      <div className=" max-w-1/2 md:mr-[6rem] mr-[0rem] md:p-0 p-5 mb-[5rem] md:mt-[7rem] mt-[1rem] md:max-w-2xl rounded-xl">
        ...
        <Card>
          <form
            ...
            action="https://buttondown.email/api/emails/embed-subscribe/rarewolf626"
          ...
          >
            ...
            <p className="mt-4 text-left text-sm text-zinc-600 dark:text-zinc-400">
              <a
                href="https://buttondown.email/refer/rarewolf626"
                target="_blank"
